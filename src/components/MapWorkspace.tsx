      ...
      {open ? (
        ...
        >
          {options.length ? (
            options.map((option) => (
              <button
                className="flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-left text-xs font-medium text-slate-700 hover:bg-indigo-50 hover:text-indigo-700 focus:bg-indigo-50 focus:text-indigo-700 focus:outline-none"
                key={option.key}
                role="menuitem"
                type="button"
                onClick={() => {
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        <p className="flex min-w-0 items-center gap-2 text-xs font-semibold text-slate-900">
                          {selection.entry.extension.icon ? (
                            <img
                              ...
                              aria-hidden="true"
                              className="size-4 shrink-0"
                              src={selection.entry.extension.icon}
                            />
                          ) : null}
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            aria-label={`Remove ${selection.entry.contribution.name} filter`}
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            aria-label={`Remove ${selection.entry.contribution.name} heatmap`}
                            className="rounded-md px-1.5 py-0.5 text-lg leading-none text-slate-300 hover:bg-slate-100 hover:text-slate-600 focus:ring-2 focus:ring-slate-300 focus:outline-none"
                            type="button"
                            onClick={() => {
                              setActiveHeatmaps((current) =>
